...
To use our Android samples, you should first install [ESRC Face SDK for Android](https://github.com/esrc-official/ESRC-Face-SDK-Android) 2.4.1 or higher on your system and should be received License Key by requesting by our email: **esrc@esrc.co.kr** <br /> 
